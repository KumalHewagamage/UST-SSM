...
class UST(nn.Module):
    ...
    def forward(self, input):
        ...
        print('after second tube embedding, xyzs shape:', xyzs.shape)
        print('after second tube embedding, features shape:', features.shape)
        B, L, n, _ = xyzs.shape
        C = features.shape[2]
        ...
        for i, downsampling_factor in enumerate(downsampling_factors):
            ...
            print(f'Branch {i}: downsampling_factor={downsampling_factor}, selected frames={indices}')
            print('  xyzs_branch shape before reshape:', xyzs_branch.shape)
            print('  features_branch shape before reshape:', features_branch.shape)
